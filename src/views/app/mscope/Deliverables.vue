<template>
  <main class="content-page">
    ...
    <div class="listing"><DeliverablesListing @setModal="setModal" /></div>
  </main>
</template>
...
import DeliverablesListing from "../../../components/tables/mscope/DeliverablesListing.vue";
export default {
  components: { SearchBar, DeliverablesListing, Button },
  props: ["getRouteName"],
  methods: {
    setModal(cmd, item) {
