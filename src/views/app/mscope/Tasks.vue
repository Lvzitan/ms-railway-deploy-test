<template>
  <main class="content-page">
    ...
    <div class="listing"><TasksListing @setModal="setModal" /></div>
  </main>
</template>
...
import TasksListing from "../../../components/tables/mscope/TasksListing.vue";
export default {
  components: { SearchBar, Button, TasksListing },
  props: ["getRouteName"],
  methods: {
    setModal(cmd, item) {
